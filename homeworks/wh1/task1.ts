...
console.log(howOldWillBeActorAfterTwentyYears(actor)); // '1420'
/**
 * В TypeScript применятся сттическая типизация данных, что позволяет быстро найти ошибку в коде, если переменной присвоено значение другого типа. В данном примере, TypeScript обнаружил ошибку - переменной типа number было присвоено строковое значение.
 */